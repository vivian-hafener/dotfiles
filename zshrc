...
#export PATH="/Users/vhafener/Library/Python/3.11/bin:$PATH"
#export PATH="/Users/vhafener/Library/Python/3.9/bin:$PATH"
# }}}

 Aliases {{{
alias history="history 0"
alias sshpiv="ssh -I/usr/lib/ssh-keychain.dylib"
